...
public interface ArticlesLocal {
  ...
  public NewsNear getNear(@PathParam("lon") double longitude, @PathParam("lat") double latitude,
      @DefaultValue("32187") @QueryParam("dm") double distance, @DefaultValue("20") @QueryParam("max") int max,
  ...
  @Path("/nn/{lon},{lat}")
  @Produces("application/json")
  public NewsNear getNeighbors(@PathParam("lon") double longitude, @PathParam("lat") double latitude,
      @DefaultValue("20") @QueryParam("max") int maxNeighbors);
